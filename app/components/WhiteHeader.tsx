  ...
  return (
    <>
      <motion.header
        ...
        className={`fixed top-0 left-0 right-0 z-100 flex items-center justify-between py-2 px-4 md:px-12 2xl:px-24 font-inter
        transition-colors duration-300 bg-white shadow-sm text-black
        ${!isOpen ? "bg-transparent text-black" : "bg-white shadow-sm text-black"}
        `}
      >
        <Link
          href="/"
