  ...
  return (
    <section className="py-16 md:py-20 lg:py-24 font-inter px-4 md:px-12 2xl:px-24 flex flex-col lg:flex-row gap-12 lg:gap-16 lg:items-center">
      ...
      <div className="w-full lg:w-1/2 flex flex-col items-start">
        ...
        <h2 className="text-3xl md:text-4xl xl:text-5xl font-medium tracking-tight uppercase mb-6 leading-[1.1]">
          Start a thoughtful <br className="hidden md:block" /> design process
        </h2>

        <p className="md:text-xl text-gray-500 mb-10 max-w-md leading-relaxed">
